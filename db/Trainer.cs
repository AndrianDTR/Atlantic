...
namespace AY
{
	namespace db
	{
		public class Trainer
		{
			...
			{
				Logger.Debug(String.Format("Set data for trainer '{0}': name='{0}', phone='{1}'", m_name, name, phone));
				if (m_id <= 0)
				{
					return;
				}
				...
				{
					Logger.Error("Data could not been changed.");
		...
		public class TrainerCollection : IEnumerable<Trainer>
		{
