...
namespace EAssistant {
    ...
    public partial class clientDataSet : global::System.Data.DataSet {
        ...
        public partial class userPrivilegesDataTable : global::System.Data.TypedTableBase<userPrivilegesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public userPrivilegesRow AdduserPrivilegesRow(string name) {
...
namespace EAssistant.clientDataSetTableAdapters {
    ...
    public partial class userPrivilegesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [main].[sqlite_default_schema].[userPrivileges] WHERE (([id] = @Origi" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [main].[sqlite_default_schema].[userPrivileges] SET [name] = @name WHERE (" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [id], [name] FROM [userPrivileges]";
